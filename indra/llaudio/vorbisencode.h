...
const size_t LLVORBIS_CLIP_REJECT_SAMPLES		= LLVORBIS_CLIP_MAX_SAMPLES + (LLVORBIS_CLIP_MAX_SAMPLES>>1);
const size_t LLVORBIS_CLIP_REJECT_SIZE			= LLVORBIS_CLIP_MAX_SAMPLE_DATA + (LLVORBIS_CLIP_MAX_SAMPLE_DATA>>1);
