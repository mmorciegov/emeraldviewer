...
AppName=GreenLife Emerald Viewer Voice Pack v2
AppVerName=GreenLife Emerald Voice v2
...
OutputBaseFilename=GreenLife_VOICE_v2-lgg
Compression=lzma
SolidCompression=yes
PrivilegesRequired=poweruser
LicenseFile=C:\emerald-setup\voicelicense.txt
...
[Files]
Source: "C:\emerald-voice-run\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
