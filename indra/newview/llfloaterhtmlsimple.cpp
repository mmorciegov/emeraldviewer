 /** 
 * @file llfloaterhtmlsimple.cpp
 * @author James Cook
 * @brief In-world HTML dialog with no navigation controls
 *
...
:	LLFloater()
{
	LLUICtrlFactory::getInstance()->buildFloater(this, "floater_html_simple.xml");

	// *TODO: set browser properties?

	navigateTo(initial_url.asString());
}


LLFloaterHtmlSimple::~LLFloaterHtmlSimple()
{
}
